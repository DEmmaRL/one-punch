  ...
  (
    (
      (
        ...
        LEFT JOIN [Reglas T - MEC] ON Tbl_cTMEC_00.PTPar = [Reglas T - MEC].RPARTIDA
      )
...
WHERE
  (
    ...
    AND (
      ([Reglas T - MEC_1].ExceptoP)= '4823'
      Or ([Reglas T - MEC_1].ExceptoP)= '7317'
    )
    AND (
  ...
  OR (
    ...
    AND (
      ([Reglas T - MEC_2].ExceptoS)= '853890'
    )
  )
ORDER BY
